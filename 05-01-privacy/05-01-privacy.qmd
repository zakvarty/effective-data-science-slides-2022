...
format:
  revealjs:
    ...
    footer: "Effective Data Science: Ethics - Privacy - Zak Varty"
    menu: true
    slide-number: true
...
:::{.notes}
In this example we have a dataset recording visits to a sexual health clinic. We wish to eastablish the k-anonymity of this data set, where the diagnosed condition should be kept private. To do help with this, the drug use status has been removed for all patients and only partial information is available about their postcode and age. 
:::

## $k$-anonymity example (2) {.smaller}
...
K anonymity ensures that there are at least k-1 other people with your particular combination of pseudo-identifiers. What it does not do is ensure that there is any variation within a particular group. The dataset on sexual health we just saw was 4-anonymous, but if we know a person how attended the clinic was from a Lancashire (LA) postcode and in their 20's then we know for certain that they have Chlamydia. An alternative privacy measure called l-diversity tries to address this issue. 
...
## Cautionary tale: Massachussets Medical Data

::::{.columns}
:::{.column width="50%"}
![Latanya Sweeney Speaking in New York, 2017. Image CC-4.0 from [Parker Higgins](https://en.wikipedia.org/wiki/User:ParkerHiggins).](images/latanya-sweeney.jpg){width="70%"}
:::
:::{.column width="50%"}
...
## Cautionary Tale: Neflix Competition 

::::{.columns}
:::{.column width="45%"}
<br><br>
![Netflix logo 2001-2014. Public domain image.](images/netflix-logo-old.png)
:::
:::{.column width="10%"}
:::
:::{.column width="45%"}
...
Thank you very much for you attention and I will see you in the next video.
:::
